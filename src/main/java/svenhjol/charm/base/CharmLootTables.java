...
public class CharmLootTables
{
    ...
    public static final ResourceLocation TREASURE_COMMON_ARMOR = LootHelper.addLootLocation(RARITY.COMMON, TYPE.MISC, new ResourceLocation(Charm.MOD_ID, "treasure/common_armor"));
    public static final ResourceLocation TREASURE_COMMON_TOOLS = LootHelper.addLootLocation(RARITY.COMMON, TYPE.MISC, new ResourceLocation(Charm.MOD_ID, "treasure/common_tools"));
    ...
    public static final ResourceLocation TREASURE_UNCOMMON_ARMOR = LootHelper.addLootLocation(RARITY.UNCOMMON, TYPE.MISC, new ResourceLocation(Charm.MOD_ID, "treasure/uncommon_tools"));
    public static final ResourceLocation TREASURE_UNCOMMON_TOOLS = LootHelper.addLootLocation(RARITY.UNCOMMON, TYPE.MISC, new ResourceLocation(Charm.MOD_ID, "treasure/uncommon_tools"));
    ...
    public static final ResourceLocation TREASURE_VALUABLE_ARMOR = LootHelper.addLootLocation(RARITY.VALUABLE, TYPE.MISC, new ResourceLocation(Charm.MOD_ID, "treasure/valuable_tools"));
    public static final ResourceLocation TREASURE_VALUABLE_TOOLS = LootHelper.addLootLocation(RARITY.VALUABLE, TYPE.MISC, new ResourceLocation(Charm.MOD_ID, "treasure/valuable_tools"));
