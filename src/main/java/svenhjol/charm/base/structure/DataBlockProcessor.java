...
public class DataBlockProcessor extends StructureProcessor {
    ...
    public static class DataBlockResolver {
        ...
        public float BLOCK_CHANCE = 0.8F;
        public float BOOKCASE_CHANCE = 0.25F;
        public float BOOKCASE_LOOT_CHANCE = 0.1F;
        public float CHEST_CHANCE = 0.66F;
        public float DECORATION_CHANCE = 0.85F;
        public float FLOWER_CHANCE = 0.8F;
        public float FLOWERPOT_CHANCE = 0.8F;
        public float LANTERN_CHANCE = 0.9F;
        public float LANTERN_GOLD_CHANCE = 0.25F;
        public float LAVA_CHANCE = 0.7F;
        public float MOB_CHANCE = 0.75F;
        public float ORE_CHANCE = 0.75F;
        public float RARE_ORE_CHANCE = 0.25F;
        public float RARE_CHEST_CHANCE = 0.1F;
        public float RUBBLE_CHANCE = 0.9F;
        public float RUNESTONE_CHANCE = 0.75F;
        public float SAPLING_CHANCE = 0.8F;
        public float SPAWNER_CHANCE = 0.8F;
        public float STORAGE_CHANCE = 0.7F;
