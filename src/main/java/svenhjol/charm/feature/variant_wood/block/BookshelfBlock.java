...
public class BookshelfBlock extends Block implements IIgniteProvider {
    private final IVariantMaterial material;

    public BookshelfBlock(IVariantMaterial material) {
    ...
    public static class BlockItem extends net.minecraft.world.item.BlockItem implements IFuelProvider {
        ...
        public BlockItem(Supplier<BookshelfBlock> block) {
