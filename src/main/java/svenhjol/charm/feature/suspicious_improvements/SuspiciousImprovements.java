package svenhjol.charm.feature.suspicious_improvements;
...
public final class SuspiciousImprovements extends CommonFeature {
    public SuspiciousImprovements(CommonLoader loader) {
        super(loader);
    }
