...
public final class Registers extends RegisterHolder<Lumberjacks> {
    ...
    public Registers(Lumberjacks feature) {
        ...
        profession = registry.villagerProfession(feature, Lumberjacks.PROFESSION_ID, Woodcutters.BLOCK_ID,
            List.of(WOODCUTTERS.registers.block), workSound);
