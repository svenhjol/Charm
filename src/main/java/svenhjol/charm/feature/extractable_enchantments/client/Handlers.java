package svenhjol.charm.feature.extractable_enchantments.client;
...
public final class Handlers extends FeatureHolder<ExtractableEnchantmentsClient> {
    public Handlers(ExtractableEnchantmentsClient feature) {
        super(feature);
    }
