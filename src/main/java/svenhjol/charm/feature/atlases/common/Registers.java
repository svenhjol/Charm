...
public final class Registers extends Register<Atlases> {
    ...
    public void onEnabled() {
        PlayerLoginEvent.INSTANCE.handle(Atlases.handlers::playerLogin);
        PlayerTickEvent.INSTANCE.handle(Atlases.handlers::playerTick);
    }
}
