...
/**
 * See me.shedaniel.rei.plugin.client.categories.cooking.DefaultCookingCategory
...
public class FiringCategory implements DisplayCategory<FiringDisplay> {
    ...
    public DisplayRenderer getDisplayRenderer(FiringDisplay display) {
        return SimpleDisplayRenderer.from(Collections.singletonList(display.getInputEntries().getFirst()), display.getOutputEntries());
    }
