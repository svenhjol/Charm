package svenhjol.charm.module.no_pet_damage;
...
public class NoPetDamage extends CharmModule {
    @Override
    ...
    private InteractionResult tryIgnoreAttack(Player player, Level level, InteractionHand hand, Entity entity, EntityHitResult hitResult) {
