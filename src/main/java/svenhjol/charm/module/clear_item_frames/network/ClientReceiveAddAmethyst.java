...
public class ClientReceiveAddAmethyst extends ClientReceiver {
    @Override
    public void handle(Minecraft client, FriendlyByteBuf buffer) {
        ...
        client.execute(() -> {
            client.level.playSound(client.player, pos, SoundEvents.SMALL_AMETHYST_BUD_PLACE, SoundSource.PLAYERS, 1.0F, 1.0F);
