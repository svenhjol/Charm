...
public class SpelunkingPotion extends CharmPotion {
    public SpelunkingPotion(CharmModule module) {
        super(module, "spelunking", new MobEffectInstance(svenhjol.charm.module.potion_of_spelunking.PotionOfSpelunking.SPELUNKING_EFFECT, PotionOfSpelunking.duration * 20));
