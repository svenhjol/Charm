        ...
        for (int i = 0; i < 9; ++i) {
            this.addSlot(new Slot(player, i, 8 + i * 18, 142) {
                ...
                public boolean mayPickup(Player playerIn) {
                    return getItem().getItem() != Atlases.ATLAS_ITEM || !Objects.equals(TagHelper.getUuid(getItem(), AtlasInventory.ID),
                        TagHelper.getUuid(atlasInventory.getAtlasItem(), AtlasInventory.ID));
                }
            });
        }
    }
