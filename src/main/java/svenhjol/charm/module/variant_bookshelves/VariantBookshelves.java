...
public class VariantBookshelves extends svenhjol.charm.loader.CommonModule {
    ...
    public static VariantBookshelfBlock registerBookshelf(svenhjol.charm.loader.CommonModule module, IVariantMaterial material) {
