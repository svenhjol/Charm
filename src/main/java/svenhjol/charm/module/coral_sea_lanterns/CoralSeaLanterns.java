...
import svenhjol.charm.module.coral_sea_lanterns.CoralSeaLanternBlock;
...
public class CoralSeaLanterns extends CharmModule {
    public static final Map<ICoralMaterial, svenhjol.charm.module.coral_sea_lanterns.CoralSeaLanternBlock> CORAL_SEA_LANTERNS = new HashMap<>();
