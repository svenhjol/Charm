...
public class VariantBarrels extends CharmCommonModule {
    ...
    public static VariantBarrelBlock registerBarrel(CharmCommonModule module, IVariantMaterial material) {
