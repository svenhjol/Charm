...
public class TooltipHelper {
    ...
    public static void renderOverlay(PoseStack matrices, List<ItemStack> items, List<ClientTooltipComponent> lines, int tx, int ty) {
        ...
        if (right > client.getWindow().getGuiScaledWidth()) {
            x -= (right - client.getWindow().getGuiScaledWidth());
        }
        ...
        TooltipHelper.renderTooltipBackground(client, matrices, x, y, 9, 3, -1);
        ItemRenderer render = client.getItemRenderer();
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                render.renderGuiItemDecorations(client.font, itemstack, xp, yp);
            }
        }
