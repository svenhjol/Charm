...
//    }
//
//    public static void sort(IItemHandler inventory, int startSlot, int endSlot) {
...
//    }
//
//    public static void populate(IItemHandler inventory, List<ItemStack> stacks, int startSlot, int endSlot) {
