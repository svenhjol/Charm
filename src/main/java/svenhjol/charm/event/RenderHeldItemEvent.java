...
public interface RenderHeldItemEvent {
    Event<RenderHeldItemEvent> EVENT = EventFactory.createArrayBacked(RenderHeldItemEvent.class, (listeners) -> (tickDelta, pitch, hand, swingProgress, stack, equipProgress, matrices, vertexConsumers, light) -> {
        for (RenderHeldItemEvent listener : listeners) {
