...
public abstract class CharmPlanksBlock extends CharmBlock {
    public CharmPlanksBlock(CommonModule module, String name, Properties settings) {
        super(module, name, settings);
    }

    public CharmPlanksBlock(CommonModule module, String name, MaterialColor color) {
