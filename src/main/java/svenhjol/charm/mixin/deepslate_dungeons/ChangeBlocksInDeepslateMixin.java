...
import svenhjol.charm.module.deepslate_dungeons.DeepslateDungeons;

import java.util.function.Predicate;

@Mixin(MonsterRoomFeature.class)
public abstract class ChangeBlocksInDeepslateMixin extends Feature<NoneFeatureConfiguration> {
    public ChangeBlocksInDeepslateMixin(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
