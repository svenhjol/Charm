...
public abstract class CharmGenerator {
    @Nullable
    protected static StructurePool registerPool(Identifier startPool, List<CharmStructure> structures, StructurePool.Projection projection) {
    ...
    @Nullable
    protected static StructurePool registerPool(Identifier startPool, List<CharmStructure> strutures) {
