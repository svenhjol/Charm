...
public class WoodcutterMenu extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(Woodcutting.recipeType.get(), new SimpleContainer(itemStack2), this.level).isPresent()) {
    ...
    public void removed(Player player) {
        ...
        this.context.execute((level, blockPos) -> this.clearContainer(player, this.input));
    }
}
