...
public class CoralSquidEntity extends WaterAnimal implements Bucketable {
    ...
    private static final EntityDataAccessor<Integer> DATA_VARIANT = SynchedEntityData.defineId(CoralSquidEntity.class, EntityDataSerializers.INT);
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(CoralSquids.bucketItem.get());
    }
