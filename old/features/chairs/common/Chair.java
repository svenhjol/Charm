...
public class Chair extends Entity {
    private final static Log LOGGER = Resolve.feature(Chairs.class).log();
    private final static Registers REGISTERS = Resolve.support(Registers.class);
    ...
    public Chair(Level level, BlockPos pos) {
        super(REGISTERS.entity.get(), level);
